...
% Let standalone class auto-crop to content (removed explicit bounding box)
...
\pic[shift={(7,5.5,0)}] at (features-east) 
    {Box={
        name=order_mlp,
        caption=Order~MLP\\1283$\rightarrow$512$\rightarrow$256$\rightarrow$9,
        fill=\OrderMLPColor,
        opacity=0.6,
        height=5,
        width={8, 6.4, 5},
...
\pic[shift={(7,2,0)}] at (features-east) 
    {Box={
        name=family_mlp,
        caption=Family~MLP\\1292$\rightarrow$512$\rightarrow$256$\rightarrow$13,
        fill=\FamilyMLPColor,
        opacity=0.6,
        height=5,
        width={8, 6.4, 5},
...
\pic[shift={(-3.5,-7,0)}] at ($(class_mlp-east) + (10,0,0)$) 
    {Box={
        name=family_out,
        caption=Family~Probabilities~(13),
...
\pic[shift={(7,-3,0)}] at (features-east) 
    {Box={
        name=genus_mlp,
        caption=Genus~MLP\\1305$\rightarrow$1024$\rightarrow$512$\rightarrow$256$\rightarrow$17,
        fill=\GenusMLPColor,
        opacity=0.6,
        height=5.5,
        width={8.4, 6.4, 5, 4},
        depth=5.5,
        xlabel={{1024, 512, 256, 17}}
        }
    };
...
\pic[shift={(-3.5,-12,0)}] at ($(class_mlp-east) + (10,0,0)$) 
    {Box={
        name=genus_out,
        caption=Genus~Probabilities~(17),
        fill=\GenusProbColor,
        opacity=0.8,
        height=3.5,
        width=3.5,
...
\pic[shift={(7,-7.5,0)}] at (features-east) 
    {Box={
        name=species_mlp,
        caption=Species~MLP\\1322$\rightarrow$1024$\rightarrow$512$\rightarrow$256$\rightarrow$82,

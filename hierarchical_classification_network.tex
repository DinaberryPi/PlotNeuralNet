...
\definecolor{lightteal}{RGB}{142,207,201}        % #8ECFC9 - Light Teal/Aqua
...
\node[canvas is zy plane at x=0] (input) at (-7.5,0,0) {\includegraphics[width=5cm,height=5cm]{pycore/diatom.png}};
